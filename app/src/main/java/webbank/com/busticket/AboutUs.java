...
public class AboutUs extends HomeActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = ProgressDialog.show(AboutUs.this, "", "Loading...");
    ...
    private class BackgroundWorker extends AsyncTask<Void, Void, Void> {
        ...
        public void getDarewod() {
            ...
            try {
                Document htmlDocument = Jsoup.connect("http://www.databankbooking.com/information/single/about-us").get();
