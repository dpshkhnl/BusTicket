...
public class OurProcess extends HomeActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Our Process");

        webview = (WebView) findViewById(R.id.webNewsEvent);
        WebSettings settings = webview.getSettings();
        settings.setJavaScriptEnabled(true);
        webview.setScrollBarStyle(WebView.SCROLLBARS_OUTSIDE_OVERLAY);
        progressBar = ProgressDialog.show(OurProcess.this, "", "Loading...");
    ...
    private class BackgroundWorker extends AsyncTask<Void, Void, Void> {
        ...
        public void getDarewod() {
            ...
            try {
                Document htmlDocument = Jsoup.connect("http://www.databankbooking.com/information/single/our-process").get();
